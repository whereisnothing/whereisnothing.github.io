...
<?php foreach ($data as $key => $value):
		...
		<a class="first-pic-title" href="http://www.f162.cn/" title="<?php echo $value["title"]; ?>" target="_blank"><?php echo $value["title"]; ?></a><p class="summary"><?php echo tool_purecontent($value["content"],80); ?>								</p>
		</li>
		<?php else: ?>
