...
function myblog(){
		...
		$pageurl =  sheli_fy($logNum, Option::get('admin_perpage_num'), $page, "/?user&posts&page=");
...
function mycomment(){
   ...
   <table class="table">
      ...
      <tbody>';
			...
			endforeach;
		$f.='</tbody>
   </table><div class="pagination"><ul>'.$pageurl.'
	</ul></div></div>  ';
		if($comment){
			return $f;
		}
...
includeLinkStyle("./content/templates/Fys/style/user.css");
</script>
